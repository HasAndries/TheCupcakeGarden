...
!function (a) {
  ...
  b.prototype.setState = function (a) {
    var b = "disabled", c = this.$element, d = c.data(), e = c.is("input") ? "val" : "ui";
  ...
  var b = '[data-toggle="dropdown"]', c = function (b) {
    ...
    a("ui").on("click.dropdown.data-api", function () {
  ...
  c.prototype = {constructor:c, toggle:function (b) {
    ...
    a("ui").on("click.dropdown.data-api", d), a("body").on("click.dropdown", ".dropdown form",
            function (a) {
              a.stopPropagation()
  ...
  b.prototype = {constructor:b, init:function (b, c, d) {
    ...
    a.find(".tooltip-inner")[this.isHTML(b) ? "ui" : "text"](b), a.removeClass("fade in top bottom left right")
  }, hide:function () {
    function d() {
  ...
  b.prototype = a.extend({}, a.fn.tooltip.Constructor.prototype, {constructor:b, setContent:function () {
    ...
    a.find(".popover-title")[this.isHTML(b) ? "ui" : "text"](b), a.find(".popover-content > *")[this.isHTML(c) ? "ui" : "text"](c), a.removeClass("fade top bottom left right in")
  }, hasContent:function () {
