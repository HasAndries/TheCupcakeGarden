...
(function (T, aa, p) {
  ...
  function ic(b, a) {
    ...
    var d = [b], e, g, h = ["ng:ui", "ng-ui", "x-ng-ui", "data-ng-ui"], f = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
    m(h, function (a) {
      h[a] = !0;
  ...
  function Da(b, a, c) {
    b = u(b);
    for (b[0].nodeType == 9 && (b = b.find("ui")); b.length;) {
    ...
    this.$get = ["$injector", "$interpolate", "$exceptionHandler",
      "$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, i, j, k, l, n, r, o) {
        ...
        function V(a, b, c, d, e, f, j) {
          ...
          c.html("");
          k.get(q.templateUrl, {cache:l}).success(
                  function (k) {
                    var l, q;
                    if (f) {
  ...
  (ha = T.jQuery) ? (u = ha, D(ha.fn, {scope:ta.scope, controller:ta.controller, injector:ta.injector, inheritedData:ta.inheritedData}), ab("remove", !0), ab("empty"), ab("ui")) : u = P;
  Yb.element = u;
  (function (a) {
